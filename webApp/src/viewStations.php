        ...
        <div style="padding:10px;"> 
            <form role="form" class="form-horizontal">
             ...
             <script type="text/javascript">
				 function load(selectObj) { 
					 ...
					 if(which=='sCode'){
						 document.getElementById('new').innerHTML = '<div class="form-group"><label for="StationCode" class="control-label col-md-3">Station Code</label><div class="col-md-8"><input class="form-control" onkeyup="showHint(this.value)" type="text" name="StationCode" id="StationCode" /></div></div><hr/>'; 
					 } else if(which=='sName'){
			...
			function showHint(str) {
				if (str.length == 0) { 
					...
					xmlhttp.open("GET", "getStationInfo.php?p=view&q=" + str, true);
					xmlhttp.send();
				}
			}
			</script>
