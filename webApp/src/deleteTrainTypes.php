        ...
        <div style="padding:10px;"> 
			...
			if(isset($_GET['error'])){
				if(!empty($_GET['error'])){
					...
					if($error == "ef"){
						...
						echo '<div class="form-group text-center" style="padding-left:100px;">
								<label class="form-control" style="height:35px;">Cannot Remove As Train Type Already Being Used In A Train.</label>
							</div>';
					} else if($error == "qf"){
						echo '<div class="form-group text-center" style="padding-left:100px;">
						...
						echo '<div class="form-group text-center" style="padding-left:100px;">
								<label class="form-control label-success" style="height:35px;">Train Type Successfully Deleted.</label>
							</div>';
					}
				}
			}
			...
			function showHint(str) {
				if (str.length == 0) { 
					...
					xmlhttp.open("GET", "getTrainTypeInfo.php?p=delete&q=" + str, true);
					xmlhttp.send();
				}
			}
			</script>
