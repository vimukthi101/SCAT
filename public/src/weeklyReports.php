    ...
    <div class="col-md-10" style="padding:20px;margin-left:160px;margin-top:45px;margin-bottom:30px;">
        ...
        <div style="padding:10px;"> 
            <div class="form-horizontal">
            	<div class="form-group">
                    <label for="date" class="control-label col-md-3">Select Week : </label>
                    <div class="col-md-8">
                ...
                <div class="form-group">
                    <div class="col-md-12 text-center">
                        <input type="submit" value="Generate" onclick="location.href='weeklyReports.php?date=' + document.getElementById('date').value;" class="btn btn-success" />
		...
		if(isset($_GET['date']) && !empty($_GET['date'])){
			...
			if(mysqli_num_rows($resultDate1)!=0 && mysqli_num_rows($resultDate2)!=0){
				...
				$strQuery = "SELECT * FROM payment WHERE payment_date_time BETWEEN '".$date1." 00:00:00' AND '".$date2." 23:59:59' AND commuter_nic='".$_SESSION['nic']."'";
		...
		if(isset($_GET['date']) && !empty($_GET['date'])){
			...
			$resultDate1 = mysqli_query($con, $getDate1);
			$resultDate2 = mysqli_query($con, $getDate2);
			if(mysqli_num_rows($resultDate1) && mysqli_num_rows($resultDate2)){
				while($rowDate1 = mysqli_fetch_array($resultDate1)){
					$date1 = $rowDate1['date1'];
				}
				while($rowDate2 = mysqli_fetch_array($resultDate2)){
				...
				$result = mysqli_query($con, $strQuery);
				  if (mysqli_num_rows($result)!=0) {
					$arrData = array(
					  "chart" => array(
						  "caption" => "Weekly Payment Charges from ".$date1." to ".$date2."",
						  "paletteColors" => "#0075c2",
						  "bgColor" => "#ffffff",
						  "borderAlpha"=> "20",
						  "canvasBorderAlpha"=> "0",
					...
					$jsonEncodedData = json_encode($arrData);
					$columnChart = new FusionCharts("column3d", "mySecondChart" , 400, 300, "chart-2", "json", $jsonEncodedData);
					$columnChart->render();
				  }
			}
		}
