...
<div class="container-fluid text-capitalize" style="padding:0px;margin:0px;">
    ...
    <div class="col-md-10" style="padding:20px;margin-left:160px;margin-top:45px;margin-bottom:30px;">
        ...
        <div style="padding:10px;"> 
            <div class="form-horizontal">
            	<div class="form-group">
                    <label for="date" class="control-label col-md-3">Enter Year : </label>
                    <div class="col-md-8">
                ...
                <div class="form-group">
                    <div class="col-md-12 text-center">
                        <input type="submit" value="Generate" onclick="location.href='annualReports.php?date=' + document.getElementById('date').value;" class="btn btn-success" />
		...
		if(isset($_GET['date']) && !empty($_GET['date'])){
			...
			$strQuery = "SELECT * FROM payment WHERE payment_date_time BETWEEN '".$q."-01-01 00:00:00' AND '".$q."-12-31 23:59:59' AND commuter_nic='".$_SESSION['nic']."'";
			$result = mysqli_query($con, $strQuery);
				if (mysqli_num_rows($result)!=0) {
				$arrData = array(
				  "chart" => array(
					  "caption" => "Annual Travels of ".$q."",
		...
		if(isset($_GET['date']) && !empty($_GET['date'])){
			...
			$result = mysqli_query($con, $strQuery);
				...
				$arrData = array(
				  "chart" => array(
					  "caption" => "Annual Payment Charges of ".$q."",
					  "paletteColors" => "#0075c2",
					  "bgColor" => "#ffffff",
					  "borderAlpha"=> "20",
					  "canvasBorderAlpha"=> "0",
