...
insert  into `address`(`address_id`,`address_no`,`address_lane`,`address_city`) values (4,'3/15A','wewala','piliyandala'),(31,'10','Imbulgoda','Gampaha'),(33,'45','Wattala','jaela'),(35,'45/78','athurugiriya','kottawa'),(36,'15','illukkumbura','rathnapura'),(37,'26','kaluthara','kaluthara'),(38,'20','raththanapitiya','boralesgamuwa');
...
insert  into `card`(`card_no`,`pin`,`station_station_code`,`issued_to_commuter`) values ('1234567841234566',1207,NULL,0),('1234567890123454',4609,NULL,0),('1234567890123455',7288,NULL,0),('1234567890123456',4303,NULL,0),('1234567890123457',5488,NULL,0);
...
insert  into `commuter`(`nic`,`contact_no`,`registered_date_time`,`status`,`credit`,`address_address_id`,`card_card_no`,`name_name_id`,`password`,`previous_password`,`login_attempt`) values ('111111111v',NULL,'2016-04-20 10:05:30',1,'5.00',31,'1234567890123455',31,'81dc9bdb52d04dc20036dbd8313ed055',NULL,0),('931340034v','0711790372','2016-05-16 10:50:20',1,'125.00',4,'1234567890123456',4,'81dc9bdb52d04dc20036dbd8313ed055',NULL,0);
...
insert  into `name`(`name_id`,`first_name`,`second_name`,`last_name`) values (4,'Vimukthi','','Saranga'),(31,'Rajitha','Gayan','Jayasekara'),(33,'Supun','Uddeepa','Kaggodaarachchige'),(35,'darshana','devinda','alwis'),(36,'aruni','','gunapala'),(37,'Thilina','samaraweera','pieris'),(38,'gihan','piymantha','dias');
...
insert  into `recharge`(`topup_id`,`recharge_date_time`,`amount`,`card_card_no`,`employee_nic`) values (1,'2016-09-30 14:39:19','100.00','1234567890123456','777777777v'),(2,'2016-09-30 14:40:06','50.00','1234567890123456','777777777v');
...
CREATE TABLE `registrar_payment` (
  ...
  PRIMARY KEY (`payment_id`),
  KEY `fk_registrar_payment_employee_position_idx` (`employee_position_position_id`),
  KEY `fk_registrar_payment_commuter1_idx` (`commuter_nic`),
  KEY `fk_registrar_payment_commuter_regfee1_idx` (`commuter_regfee_regfee_id`),
  ...
  CONSTRAINT `fk_registrar_payment_commuter_regfee1` FOREIGN KEY (`commuter_regfee_regfee_id`) REFERENCES `mydb`.`commuter_regfee` (`regfee_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_registrar_payment_employee_position` FOREIGN KEY (`employee_position_position_id`) REFERENCES `employee_position` (`position_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
insert  into `staff`(`employee_id`,`employee_position_position_id`,`employee_nic`,`station_code`) values ('E001',1,'931340034v','all'),('E002',2,'111111111v','all'),('E003',3,'222222222v','COL'),('E004',3,'333333333v','KKS'),('E005',4,'555555555v','COL'),('E006',5,'666666666v','COL');
...
insert  into `ticket`(`ticket_id`,`ticket_fee`,`station_in_station_code`,`station_out_station_code`) values (1,'50.00','KKS','COL');
...
insert  into `topup_agent`(`agent_reg_date_time`,`topup_agent_status_id`,`topup_agent_regfee_id`,`employee_nic`,`topup_agent_id`,`station_code`) values ('2016-09-30 14:33:45',1,3,'777777777v','T001','COL');
...
insert  into `train`(`train_id`,`train_name`,`train_type_type_id`) values (1,'Yaldevi','EXP');
